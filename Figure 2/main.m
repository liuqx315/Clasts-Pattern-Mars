function [fitps,result]=main

%Computation of Figure 2 and Extended data Tables 3 and 4 for
%Zheng Zhu, Bernard Hallet, András A. Sipos, Gábor Domokos and Quan-Xing Liu:
%Self-organization of clasts on sand surfaces in Gale crater, Mars
%
...
[h,p,ktest] = kstest2(areas/mean(areas),areas2/mean(areas2),'Alpha',0.05)
[h,p,ktest] = kstest2(edgelength/mean(edgelength),edgelength2/mean(edgelength2),'Alpha',0.05)
